...
(
    ...
    addr			CHAR(2) NOT NULL, -- 지역(경기, 서울, 성남 식으로 2글자만 입력)
    mobile1		CHAR(3), -- 핸드폰 번호 앞 3자리
    mobile2		CHAR(8), -- 핸드폰 번호 나머지. 하이픈 제외
    height		SMALLINT, -- 키
    mDate			DATE -- 회원 가입일
);
...
(
  ...
  prodName    CHAR(6) NOT NULL, -- 구매 상품명
  groupName   CHAR(4), -- 분류
...
INSERT INTO buyTbl VALUES (NULL, 'KBS', N'청바지', N'서적', 50, 3);
